...
// location saved list
	$('body').on('change','.evoau_location_select',function(){
		...
		// address
		FORM.find('input[name=evcal_location_name]').val(option.text());
		FORM.find('input[name=evcal_location_name_]').val(option.text());
		FORM.find('input[name=evcal_location]').val(option.attr('data-add'));
		FORM.find('input[name=evcal_location_]').val(option.attr('data-add'));
		FORM.find('input[name=evo_loc_img_id]').val(option.attr('data-img'));
		
		if(option.attr('data-lat')!= '' && option.attr('data-lat')!== undefined) 
			FORM.find('input[name=event_location_cord]').val(option.attr('data-lat')+','+option.attr('data-lon'));
	});

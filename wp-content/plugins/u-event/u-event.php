...
class U_event{
	...
	function getAvailable() {
		...
		$product=get_product($product_id);
			if($product!==false) {
				$variations=$product->product_type;
			}
		}
		return $variations;
	}
	...
	function includes(){
		...
		//include_once('classes/u-event-query.php');
	}
...
//		add_filter('manage_u_event_cat_custom_column', array($this,'custom_u_event_cat_column_value'));
	...
	function register_u_event(){
		$labels = array(
			...
			'all_items'          => __('All Event', 'cactusthemes'),
	...
	function register_post_type_metadata(array $meta_boxes){
		...
		$u_event_fields = array(	
				array( 'id' => 'u-startdate', 'name' => __('Start Date', 'cactusthemes'), 'type' => 'datetime_unix' , 'repeatable' => false, 'multiple' => false),	
				array( 'id' => 'u-enddate', 'name' => __('End Date', 'cactusthemes'), 'type' => 'datetime_unix', 'repeatable' => false, 'multiple' => false ),	
				...
				array( 'id' => 'product_id', 'name' => __('Product','cactusthemes'), 'type' => 'post_select', 'use_ajax' => true, 'query' => array( 'post_type' => 'product' ),'allow_none' => true, 'desc' => __('Select a WooCommerce product to sell this event', 'cactusthemes'), 'repeatable' => false, 'multiple' => false ),	
				...
				array( 'id' => 'u-linkssub', 'name' => __('Subscribe URL', 'cactusthemes'), 'type' => 'text', 'textarea','desc' => __('Link to a subscribe form. Only work if no product is set.', 'cactusthemes') , 'repeatable' => false, 'multiple' => false),

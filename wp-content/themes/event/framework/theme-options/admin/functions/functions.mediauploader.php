...
/**
 * WooThemes Media Library-electrifyn AJAX File Uploader Module (2010-11-05)
 *
 ...
 * Media Library-electrifyn AJAX File Uploader Module.
 */
...
if ( ! function_exists( 'optionsframework_mlu_modify_tabs' ) ) {
	...
	function optionsframework_mlu_modify_tabs ( $tabs ) {
		$tabs['gallery'] = str_replace( __( 'Gallery', 'innwit' ), __( 'Previously Uploaded', 'innwit' ), $tabs['gallery'] );
		return $tabs;
	}
}

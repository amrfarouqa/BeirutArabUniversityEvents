...
class Pix_Like_Me{
	...
	public function like_me_scripts(){
		wp_enqueue_script( 'like-me-scripts', THEME_FUNCTIONS_URI .'/pix-like-me/js/like-me.js', array( 'jquery' ), '2.0', true);
		wp_localize_script( 'like-me-scripts', 'pixLike',
			array( 
				'ajaxurl' => admin_url( 'admin-ajax.php' ),
				'liked' => __('You already liked this!', 'innwit')
			)
		);
	}
...
// instantiate class
$GLOBALS['pix_like_me'] = new Pix_Like_Me();
...
class Pix_Popular_Post_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_options = array('classname' => 'popularpost', 'description' => __('Display Popular Posts','innwit'));
		parent::__construct('pix_popular_post',__('Innwit:: Popular Post','innwit'),$widget_options);
	}
	...
	function widget($args, $instance) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Popular Posts','innwit' );
		...
		$posts_cpt_ID = $wpdb->get_results("SELECT ID
                    FROM $wpdb->posts WHERE post_type = 'post' AND post_status = 'publish'", ARRAY_N);

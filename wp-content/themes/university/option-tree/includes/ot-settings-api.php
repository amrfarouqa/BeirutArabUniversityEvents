          ...
          if ( ! isset( $page['hidden_page'] ) && $screen->id == $this->page_hook[$page['id']] ) {
            ...
            if ( $show_buttons ) {
              ...
              echo '<div id="option-tree-settings-api">';
				...
				echo '<span class="option-tree-ui-button button button-primary right document"><a href="http://doc.cactusthemes.com/university/">Documentation</a></span>';
				echo '<span class="option-tree-ui-button button button-primary grey right support"><a href="http://ticket.cactusthemes.com/">Support Forum</a></span>';
              ...
              if ( $show_buttons ) {
				...
				echo '<a href="' . str_replace( '&settings-updated=true', '', $_SERVER["REQUEST_URI"] ) .'&import_data=true" class="button red" style="left:30px;position: relative;top: -40px;height: 30px; padding-top: 3px" onclick="return confirm(\'This will import sample data. It may take a couple of minutes to finish. Are you sure?\');">' . __('Import Sample Data','cactusthemes') . '</a>';

...
<style type="text/css" >
	@media only screen and (-webkit-min-device-pixel-ratio: 2),(min-resolution: 192dpi) {
		/* Retina Logo */
		.logo{background:url(http://dev.cactusthemes.com/university/wp-content/uploads/2014/09/Logo-dark-2X.png) no-repeat center; display:inline-block !important; background-size:contain;}
...
<?php
	...
	global $page_title;
	if(is_search()){
		$page_title = __('Search Result: ','cactusthemes').(isset($_GET['s'])?$_GET['s']:'');
	}elseif(is_category()){
                ...
                <nav class="navbar navbar-inverse main-color-2-bg" role="navigation">
                    <div class="container">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="logo" href="<?php echo home_url(); ?>"><img src="http://dev.cactusthemes.com/university/wp-content/uploads/2014/09/Logo-dark-1X.png" alt="logo"></a>
                            <?php else:?>
                            <a class="logo" href="<?php echo get_home_url(); ?>" title="<?php wp_title( '|', true, 'right' ); ?>"><img src="http://dev.cactusthemes.com/university/wp-content/uploads/2014/09/Logo-dark-1X.png" alt="<?php wp_title( '|', true, 'right' ); ?>"/></a>
                            <?php endif;?>
